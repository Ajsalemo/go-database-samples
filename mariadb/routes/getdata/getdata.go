...
import (
	...
	db "github.com/Ajsalemo/go-database-samples/mariadb/config/db"
)

// NOTE: The properties MUST be uppercase, even if the fields we're trying to access in MariaDB are lowercase
