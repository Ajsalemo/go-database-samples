...
import (
	...
	db "github.com/Ajsalemo/go-database-samples/postgres/config/db"
)

// NOTE: The properties MUST be uppercase, even if the fields we're trying to access in Postgres are lowercase
