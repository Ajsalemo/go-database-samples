...
import (
	...
	db "github.com/Ajsalemo/go-database-samples/mssql/config/db"
)

// NOTE: The properties MUST be uppercase, even if the fields we're trying to access in MSSQL are lowercase
